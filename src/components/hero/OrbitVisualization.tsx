...
export function OrbitVisualization() {
  return (
    <div className="relative w-full h-full min-h-[400px] lg:min-h-[500px] flex items-center justify-center">
      {/* Static orbit rings */}
      <div className="absolute w-[280px] h-[280px] lg:w-[400px] lg:h-[400px] rounded-full border border-border/20" />
      <div className="absolute w-[200px] h-[200px] lg:w-[300px] lg:h-[300px] rounded-full border border-border/30" />
      <div className="absolute w-[120px] h-[120px] lg:w-[200px] lg:h-[200px] rounded-full border border-border/40" />

      {/* Static avatars - outer ring */}
      <div className="absolute w-[280px] h-[280px] lg:w-[400px] lg:h-[400px]">
      ...
      {/* Static avatars - middle ring */}
      <div className="absolute w-[200px] h-[200px] lg:w-[300px] lg:h-[300px]">
        {avatars.slice(3, 6).map((avatar, i) => (
          <motion.div
            ...
            style={{
              top: '50%',
              left: '50%',
              transform: `rotate(${i * 120 + 60}deg) translateX(100px) rotate(-${i * 120 + 60}deg) translate(-50%, -50%)`,
            }}
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
